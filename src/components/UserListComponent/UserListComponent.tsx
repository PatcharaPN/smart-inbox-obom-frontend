...
const UserListComponent = ({ user }: UserListComponentProps) => {
  ...
  return (
    <>
      {sortedUsers.map((u) => (
        <div
          key={u.id}
          className="z-1 sticky w-full bg-white grid grid-cols-[40px_100px_3fr_3fr_1fr_1fr_1fr] md:grid-cols-[40px_100px_3fr_2fr_2fr_1fr_1fr] gap-2 items-center border-b border-gray-200"
        >
